...
export const getOffsetHeightForPrimaryTable = (extra: number = 0): string => { // For Primary Table
  const totalHeight = getTotalHeight("ofH_calc_nav_bar") + getTotalHeight("ofH_calc_body_header") + getTotalHeight("ofH_calc_pagin") + getTotalHeight("ofH_calc_mob_globel_filter");
